...
<div role="main" class="main">
    ...
    <section class="page-header page-header-modern page-header-background bg-color-dark p-relative z-index-1 lazyload" data-bg-src={{url("frontend/img/demos/digital-agency-2/bg/Career.jpg")}} >
        ...
        <div class="container">
            <div class="row mt-5">
                <div class="col">
                    ...
                    <h1 class="custom-text-10 font-weight-bold">Careers</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="mt-3 mt-xl-0 py-5 p-relative z-index-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="d-block w-100 text-color-dark custom-text-10 font-weight-bold text-center mb-4 pb-3 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">Join us for great career<span class="text-color-primary">.</span></h4>
            ...
            <div class="row">
                    ...
                    <div class="row px-3">
                        ...
                        <div class="col-xl-6 ms-0 overflow-hidden col-where-you-are-postal">
                            <div class="row justify-content-end p-relative h-100">
                                <img src="{{url("frontend/img/demos/digital-agency-2/contact-us/contact-us-2.jpg")}}" class="img-fluid">
                ...
                <div class="col-lg-12">
                    <h4 class="text-color-dark custom-text-10 font-weight-bold text-center custom-title-with-icon-center custom-title-with-icon custom-title-with-icon-primary pt-5 mt-5 mb-5">Apply now for a vacancy</h4>
                    <form class="contact-form" action="php/contact-form.php" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <input type="text" value="" data-msg-required="Please enter the designation." data-msg-designation="Please enter a valid designation." maxlength="100" class="form-control py-4 px-4 rounded-0 text-color-quaternary bg-color-tertiary border-0 appear-animation" name="designation" id="designation" placeholder="Designation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200" required>
                            </div>
                            <div class="form-group col-lg-6">
                                <input type="file" value="" data-msg-required="Please choose the resume." class="form-control py-4 px-4 rounded-0 text-color-quaternary bg-color-tertiary border-0 appear-animation" name="resume" id="resume" placeholder="Resume" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col">
                                <textarea maxlength="5000" data-msg-required="Please enter your about." rows="8" class="form-control py-4 px-4 rounded-0 text-color-quaternary bg-color-tertiary border-0 appear-animation" name="about" id="about" placeholder="About Yourself" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200" required></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col">
                                <button type="submit" herf="demo-digital-agency-2-our-blog.html" class="btn btn-outline custom-btn-outline btn-primary rounded-0 text-color-dark custom-text-4 bg-color-hover-transparent text-color-hover-light font-weight-semibold custom-button-with-arrow px-4 py-3 appear-animation" data-loading-text="Loading..." data-appear-animation="fadeInRightShorter" data-appear-animation-delay="600">Apply Now</button>
                            </div>
                        </div>
                    </form>
                </div>
